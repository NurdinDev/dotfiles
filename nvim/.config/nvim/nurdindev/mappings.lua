local vim = vim
local utils = require'nurdindev.utils'
...
local setup_mappings = function()
  ...
  -- Telescope
  utils.key_mapper('n', '<C-p>', ':lua require"nurdindev.telescope".find_files()<CR>')
  utils.key_mapper('n', '<leader>fs', ':lua require"nurdindev.telescope".live_grep()<CR>')
  utils.key_mapper('n', '<leader>fw', ':lua require"nurdindev.telescope".grep_string(vim.fn.expand("<cword>"))<CR>')
  utils.key_mapper('n', '<leader>fh', ':lua require"nurdindev.telescope".help_tags()<CR>')
  utils.key_mapper('n', '<leader>fb', ':lua require"nurdindev.telescope".buffers()<CR>')
  utils.key_mapper('n', '<leader>fq', ':lua require"nurdindev.telescope".quickfix()<CR>')
  utils.key_mapper('n', '<leader>fd', ':lua require"nurdindev.telescope".dotfiles()<CR>')
