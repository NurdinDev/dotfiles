#!/usr/bin/env /Users/nureddin/.local/share/mise/installs/node/lts/bin/node
...
const coordinates = new Coordinates(41.093722, 28.654022);
...
const bitbarOutput = [
  {
    ...
    color: diffInSeconds < 1800 ? "red" : darkMode ? 'white' : 'black',
    dropdown: false,
  },
  separator,
  ...bitbarItems,
...
bitbar(bitbarOutput, { font: "MonoLisa", size: "12" });
